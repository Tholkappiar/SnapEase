...
class API extends REST
{
    ...
    */
    public function processApi()
    {
        ...
        if (!isset($_GET['namespace']) and (int)method_exists($this, $func) > 0) {
            ...
            if (isset($_GET['namespace'])) {
                $dir = $_SERVER['DOCUMENT_ROOT'].'/_libs/api/'.$_GET['namespace'];
    ...
    // TODO : Sessions validate getUser and getUsername

    // public function isAuthenticatedFor(User $user)
    // {
    //     return Sessions::getUser()->getEmail() == $user->getEmail();
    // }

    // public function getUsername()
    // {
    //     return Sessions::getUser()->getUsername();
    // }
